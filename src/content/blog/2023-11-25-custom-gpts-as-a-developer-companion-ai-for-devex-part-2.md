...
![Starting a conversation to build a GPT](/img/import/2023-11-01-custom-gpt-start.png)

Starting a conversation to build a GPT

![Ongoing Conversation](/img/import/2023-11-02-custom-gpt-setting-a-name.png)

Ongoing Conversation

![Creating a GPT image](/img/import/2023-11-03-custom-gpt-further-customization.png)

Creating a GPT image

![Setting tone and and output requirements](/img/import/2023-11-04-custom-gpt-tone.png)

Setting tone and and output requirements

![The Spring Buddy is ready to be used.](/img/import/2023-11-05-custom-gpt-ready-now.png)
...
![Asking Spring Buddy to create an API to store books + tests.](/img/import/2023-11-06-run-gpt-steps.png)

Asking Spring Buddy to create an API to store books + tests.

![Generated Model and Repository](/img/import/2023-11-07-run-gpt-model.png)

Generated Model and Repository

![Generated Service](/img/import/2023-11-08-run-gpt-service.png)

Generated Service

![Generated Controller](/img/import/2023-11-09-run-gpt-controller.png)

Generated Controller

![Generated Test Boilerplate](/img/import/2023-11-10-run-gpt-test.png)
...
![Asking Spring Buddy to finish the test](/img/import/2023-11-11-run-gpt-write-test.png)

Asking Spring Buddy to finish the test

![The test implementation](/img/import/2023-11-12-run-gpt-test-response.png)
...
![The (mostly) autogenerated GPT configuration.](/img/import/2023-11-13-adr-gpt-config.png)
...
![OpenAPI Spec for my N8N workflow](/img/import/2023-11-14-adr-gpt-action.png)
...
![Extremely simply N8N Workflow](/img/import/2023-11-23-adr-assistant-n8n-backend.png)
...
![The assistant prompts me for the ADR details.](/img/import/2023-11-15-adr-assistant-in-action.png)
...
![A raw collection of input for the ADR](/img/import/2023-11-16-adr-assistant-content-bulletpoints.png)

A raw collection of input for the ADR

The assistant still has questions, which I answer briefly:

![Briefly answering assistant questions](/img/import/2023-11-17-adr-assistant-asks-questions.png)

Briefly answering assistant questions

The assistant now creates a draft for the ADR and asks me if I want to upload it.

![The Draft ADR](/img/import/2023-11-18-adr-assistant-creates-draft.png)
...
![I changed my mind.](/img/import/2023-11-19-adr-assistant-refining-the-adr.png)

I changed my mind.

The assistant does not disappoint:

![The Next Version of the ADR](/img/import/2023-11-20-adr-assistant-rewriten-adr.png)

The Next Version of the ADR

I am satisfied with this version. Time to store it, discuss it, review it, and finalize it.

![The ADR is sent to my N8N instance.](/img/import/2023-11-21-adr-assistant-upload.png)
...
![The ADR in GitHub](/img/import/2023-11-22-adr-assistant-adr-in-github.png)
